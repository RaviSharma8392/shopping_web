...
const CategoriesCard = ({ cat }) => {
  ...
  return (
    <div
      ...
      className="cursor-pointer shrink-0 w-64 group">
      <div className="relative w-full h-80 md:h-[420px] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.04)] hover:shadow-[0_6px_28px_rgba(0,0,0,0.10)] transition-all duration-500 bg-white">
        ...
        {/* Soft overlay */}
        <div className="absolute inset-0 bg-linear-to-b from-white/10 via-white/0 to-black/60 opacity-60 group-hover:opacity-80 transition-all duration-500" />
